...
def get_connection():
    connection = pymysql.connect(host='localhost', user='root', password='Tatti@0607', database='varun7703')
    return connection
...
def accept(id, name, team_members, technology, deadline):
    ...
    query = '''insert into projectinfo values ({},\'{}\',\'{}\',\'{}\',\'{}\');'''.format(id, name, team_members,
                                                                                          technology, deadline)
